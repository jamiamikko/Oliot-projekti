...
/**
 * Tama on luokka InfraredSignalCheckerThread, joka laajentaa Thread saikeen.
 * Luokka huolehtii robotin liikkumiseen tarvittavista toiminnoista.
 * 
 * @author villeleino
 *
 */
...
public class InfraredSignalCheckerThread extends Thread {
	...
	public void run() {
		...
		while (Button.ESCAPE.isUp()) {
			...
			// Saanto joka pitaa loopin paalla muuttaa kaukosaatimen komennon
			// int muotoon
			...
			case 3:
				// Kaantaa kaantomoottorie 10 astetta vasempaan, hidastaa
				// vasenta moottoria, nuoli vasempaan
